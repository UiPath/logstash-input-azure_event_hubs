...
require_jar('com.fasterxml.jackson.datatype', 'jackson-datatype-joda', '2.21.2')
...
require_jar('com.nimbusds', 'nimbus-jose-jwt', '10.9')
...
require_jar('org.jetbrains.kotlin', 'kotlin-stdlib', '2.3.20')
...
require_jar('joda-time', 'joda-time', '2.12.7')
